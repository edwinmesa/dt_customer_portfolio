...
class extractDatabaseData:
    def __init__(self):
        ...
        self.inputSqlFiles  = f"/home/pydev/workflow/dt_customer_portfolio/sql/queryPortfolio.sql"
        
    def extractData(self, name):
        with open(self.inputSqlFiles, 'r') as self.f_in:
            ...
            df_sqlfact.to_csv(f"{self.outputDir}{name}", index=None, header=True, encoding='utf-8', lineterminator='\n')

data = extractDatabaseData()
data.extractData("customerPortfolio.csv")