...
path            = f"/home/pydev/workflow/dt_customer_portfolio/data/"
...
try:
    ...
    engine = sqlalchemy.create_engine(
            "oracle+cx_oracle://SIE_TI_BD:Cloud2019@192.168.0.30:1521/?service_name=SIESA", arraysize=9000)
    con = engine.connect()
    df_sqlfact = pd.read_sql(sqlCustomer, engine)
    df_sqlfact.to_csv(f"{path}customerPortfolio.txt", index=None, header=False, sep='\t', encoding='utf-8', lineterminator='\n')
